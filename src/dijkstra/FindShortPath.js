...
async function main() {
    ...
    let currentNode = graph.getNode(1);
    const computedRoutes = new ComputedRoutes(graph);
    computedRoutes.addRoute(0, currentNode);
    ...
    console.log(computedRoutes.getCost(7));
    console.log(computedRoutes.getCost(37));
    console.log(computedRoutes.getCost(59));
    console.log(computedRoutes.getCost(82));
    console.log(computedRoutes.getCost(99));
    console.log(computedRoutes.getCost(115));
    console.log(computedRoutes.getCost(133));
    console.log(computedRoutes.getCost(165));
    console.log(computedRoutes.getCost(188));
    console.log(computedRoutes.getCost(197));
}
